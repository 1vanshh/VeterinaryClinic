...
public class ListMyAppointmentsCommand implements Command {

    private final long doctorId;
    private final AppointmentService service;

    // формат “timestamptz-подобный” (оффсет обязателен)
    private static final DateTimeFormatter OUT_FMT = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ssXXX");

    public ListMyAppointmentsCommand(long doctorId, AppointmentService service) {
